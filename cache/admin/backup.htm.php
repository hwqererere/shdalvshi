<?php /* Smarty version 2.6.26, created on 2015-11-26 14:41:10
 ...
 KB </td>
      ...
      <tr>
       <td colspan="7" align="center">
        <?php echo $this->_tpl_vars['lang']['backup_sql_file_name']; ?>
：<input type="text" class="inpMain" name="file_name" value="<?php echo $this->_tpl_vars['file_name']; ?>
" size=30>
...
"  onClick="document.myform.action='backup.php?rec=backup'">
    ...
    <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
     <tr>
      <th width="" align="left"><?php echo $this->_tpl_vars['lang']['backup_sql_file_name']; ?>
</th>
...
?>
     <tr<?php if ($this->_tpl_vars['file']['number'] > 1): ?> class="child"<?php endif; ?>>
      <td align="left"><?php echo $this->_tpl_vars['file']['sql_file_name']; ?>
</td>
      <td align="center"><?php echo $this->_tpl_vars['file']['filesize']; ?>
</td>
      <td align="center"><?php echo $this->_tpl_vars['file']['maketime']; ?>
</td>
      <td align="center"><?php if ($this->_tpl_vars['file']['number'] <= 1): ?><a href="backup.php?rec=import&sql_file_name=<?php echo $this->_tpl_vars['file']['sql_file_name']; ?>
"><?php echo $this->_tpl_vars['lang']['backup_sql_pre']; ?>
</a> | <a href=backup.php?rec=down&sql_file_name=<?php echo $this->_tpl_vars['file']['sql_file_name']; ?>
><?php echo $this->_tpl_vars['lang']['down']; ?>
</a> | <a href=backup.php?rec=del&sql_file_name=<?php echo $this->_tpl_vars['file']['sql_file_name']; ?>
